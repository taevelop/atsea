...
- 초롱아귀의 발광구는 2D와 같은 노란색으로 빛나며, 부드러운 노란 후광이 실제 발광구의 수영·방향 전환을 따라갑니다. 희귀형은 청백색 몸체와 노란 발광구를 함께 유지합니다. 해저 지형에는 발광구 아래로 노란 빛이 번지고 높아질수록 약해지며, 개체가 화면 밖으로 나가면 사라집니다. 발광의 맥동은 일시정지와 함께 멈추고, 도감의 미발견 실루엣에는 후광을 표시하지 않습니다.
